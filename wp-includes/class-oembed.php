...
class WP_oEmbed {
	...
	/**
     * 获取一个URL并返回相应的oEmbed提供者的URL，如果有的话。
	...
	/**
     * 尝试在给定的URL中发现链接标签，以供oEmbed提供者使用。
	...
	/**
     * 将数据对象转换为WP_oEmbed::fetch()并返回HTML。
